...
* **[AAAI2022 DLB]** Memory-Based Jitter: Improving Visual Recognition on Long Tailed Data with Diversity in Memory [[Paper]()]
* **[AAAI2022 DLB]** Contrastive quantization with code memory for unsupervised image retrieval [[Paper]()]
* **[AAAI2022 DLB]** InsCLR: Improving instance retrieval with self-supervision [[Paper]()]
* **[CVPR2022 DLB]** Learning Memory-Augmented Unidirectional Metrics for Cross-Modality Person Re-Identification [[Paper]()]
* **[CVPR2022 DLB]** Cross Modal Retrieval with Querybank Normalisation [[Paper]()]
* **[CVPR2022 DLB]** Cross-Image Relational Knowledge Distillation for Semantic Segmentation [[Paper]()]
* **[ECCV2022 DLB]** DAS: Densely-Anchored Sampling for Deep Metric Learning [[Paper]()]
* **[Arxiv2022 DLB]** Memorizing transformers [[Paper]()]
* **[Arxiv2022 DLB]** Learning Equivariant Segmentation with Instance-Unique Querying [[Paper]()]
* **[Arxiv2022 DLB]** Online Knowledge Distillation via Mutual Contrastive Learning for Visual Recognition [[Paper]()]
* **[AAAI2021 DLB]** Instance mining with class feature banks for weakly supervised object detection [[Paper]()]
* **[CVPR2021 DLB]** Exploring classification equilibrium in long-tailed object detection [[Paper]()]
* **[CVPR2021 DLB]** Variational prototype learning for deep face recognition [[Paper]()]
* **[CVPR2021 DLB]** Group-aware label transfer for domain adaptive person re-identification [[Paper]()]
* **[CVPR2021 DLB]** Mining contextual information beyond image for semantic segmentation [[Paper]()]
* **[CVPR2021 DLB]** Spatial assembly networks for image representation learning [[Paper]()]
* **[CVPR2021 DLB]** Noise-resistant deep metric learning with ranking-based instance selection [[Paper]()]
* **[ICCV2021 DLB]** Exploring classification equilibrium in long-tailed object detection [[Paper]()]
* **[NeurIPS2021 DLB]** When False Positive is Intolerant: End-to-End Optimization with Low FPR for Multipartite Ranking [[Paper]()]
* **[TIP2021 DLB]** Dual-refinement: Joint label and feature refinement for unsupervised domain adaptive person re-identification [[Paper]()]
* **[CVPR2020 DLB]** Cross-Batch Memory for Embedding Learning [[Paper]()]
* **[CVPR2020 DLB]** Self-supervised learning of pretext-invariant representations [[Paper]()]
* **[ECCV2020 DLB]** Unsupervised Deep Metric Learning with Transformed Attention Consistency and Contrastive Clustering Loss [[Paper]()]
...
* **[ICLR2018 DLB]** Memory-based Parameter Adaptation [[Paper]()]
